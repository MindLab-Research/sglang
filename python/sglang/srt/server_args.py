...
class ServerArgs:
    ...
    bf16_gemm_backend: A[
        str,
        Arg(
            help="Choose the backend for unquantized BF16 GEMM operations. Options: 'auto' (default; uses cuBLAS via torch.nn.functional.linear), 'tgv' (SGLang JIT CuTe DSL TGV BF16 GEMM on Blackwell (SM100/SM103); dispatches between TGV and cuBLAS with a fixed M/N/K heuristic).",
