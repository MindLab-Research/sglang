        ...
        if is_bare_tekken_checkpoint(tokenizer_name, tokenizer_revision):
            ...
            if (
                ...
                try:
                    ...
                    # slow-class retry cannot find a concrete class and raises.
                    # The generic fast TokenizersBackend instance is fully
                    # functional (vocab + added tokens); keep it as-is instead
                    # of failing the tokenizer load entirely.
                    logger.warning(
