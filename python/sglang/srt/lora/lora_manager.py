...
def init_lora_cuda_graph_moe_buffers(
    *,
    ...
    # EAGLE draft extends the batch by speculative_num_draft_tokens, so the
    # shared MoE LoRA graph buffers must cover the widened batch.
    if spec_algorithm is not None and spec_algorithm.is_speculative():
        sdt = server_args.speculative_num_draft_tokens
