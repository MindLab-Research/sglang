...
class PrefillBootstrapQueue:
    ...
    def _init_kv_manager(self) -> CommonKVManager:
        ...
        layer_shard_rank = getattr(token_to_kv_pool, "layer_shard_rank", None)
        layer_shard_size = getattr(token_to_kv_pool, "layer_shard_size", 1)
        ...
        kv_args.prefill_start_layer = (
            ...
            else token_to_kv_pool.start_layer
        )
        ...
        kv_args.prefill_end_layer = (
            ...
            if layer_shard_enabled
            else getattr(token_to_kv_pool, "end_layer", None)
        )
