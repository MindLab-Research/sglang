...
class Glm5NextForConditionalGeneration(nn.Module):
    ...
    def _prepare_context_parallel_metadata(
        ...
        _lg.warning(f"CP_DEBUG: cp_size={getattr(self,'cp_size',None)}, dsa_enable_prefill_cp={getattr(self,'dsa_enable_prefill_cp',None)}, mla_enable_prefill_cp={getattr(self,'mla_enable_prefill_cp',None)}, forward_mode={forward_batch.forward_mode}, is_cp_extend={forward_batch.forward_mode.is_context_parallel_extend()}")
